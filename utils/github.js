...
export async function listAllTeamRepos({ apiKey, organization, teamSlug }) {
  const octokit = new Octokit({ auth: apiKey })
...
export async function listAllTeamMembers({ apiKey, organization, teamSlug }) {
  const octokit = new Octokit({ auth: apiKey })
...
export async function listAllTeamMembersWithTeamSlug({ apiKey, organization, teamSlug }) {
  const octokit = new Octokit({ auth: apiKey })
...
export async function listAllOrgMembers({ apiKey, organization }) {
  const octokit = new Octokit({ auth: apiKey })
...
export async function listOrgActivities({ apiKey, organization, perPage = 30 }) {
  const octokit = new Octokit({ auth: apiKey })
...
export async function createTeam({ apiKey, organization, teamName, privacy = "closed", teamDescription = "" }) {
  const octokit = new Octokit({ auth: apiKey })
...
export async function deleteTeam({ apiKey, organization, teamSlug }) {
  const octokit = new Octokit({ auth: apiKey })
...
export async function inviteMemberToTeam({ apiKey, organization, teamSlug, member }) {
  const octokit = new Octokit({ auth: apiKey })
...
export async function removeMemberFromTeam({ apiKey, organization, teamSlug, member }) {
  const octokit = new Octokit({ auth: apiKey })
